...
+ (void) testEncodeAndDecodeDupTwo16BPP
{
  ...
  uint32_t inputBuffer32NumWords = (uint32_t) (c4Codes.length / sizeof(uint32_t));
...
+ (void) testEncodeAndDecodeSmallDup16BPP
{
  ...
  codes = maxvid_encode_generic_delta_pixels16(prev, curr, (uint32_t)(sizeof(curr)/sizeof(uint16_t)), width, height, NULL, 0);
  results = [MaxvidEncodeTests util_printMvidCodes16:codes];
...
+ (void) testEncodeAndDecodeSmallDup32BPP
{
  ...
  codes = maxvid_encode_generic_delta_pixels32(prev, curr, (uint32_t)(sizeof(curr)/sizeof(uint16_t)), width, height, NULL, 0);
  results = [MaxvidEncodeTests util_printMvidCodes32:codes];
...
+ (void) testEncodeAndDecodeSmallCopy32BPP
{
  ...
  codes = maxvid_encode_generic_delta_pixels32(prev, curr, (uint32_t)(sizeof(curr)/sizeof(uint32_t)), width, height, NULL, 0);
  results = [MaxvidEncodeTests util_printMvidCodes32:codes];
