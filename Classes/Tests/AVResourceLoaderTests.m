...
+ (void) testBlackBlue2x2_16BPP
{
  ...
  NSString *tmpMovPath = [resLoader _getTmpDirPath:resLoader.movieFilename];
  
  if ([resLoader _fileExists:tmpMovPath]) {
    BOOL worked = [[NSFileManager defaultManager] removeItemAtPath:tmpMovPath error:nil];
