               ...
               alphaPath:(NSString*)alphaPath
{
  ...
  for (NSUInteger frameIndex = 0; frameIndex < numFrames; frameIndex++) {
    ...
    for (NSUInteger pixeli = 0; pixeli < numPixels; pixeli++) {
      ...
      // FIXME: additional optimizations possible in this premultiply
      // operation. Currently, there is a function call and other
      // shifting. This could be rewritten to init the table once instead
      // of for each pixel.
